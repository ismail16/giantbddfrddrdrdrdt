    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-success">
                ...
                <form action="{{route('admin.refundPolicy.store')}}" role="form"
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                <textarea name="refund_description" id="editor1" class="form-control ckeditor" cols="5"
                                          rows="2"
                                          placeholder="Enter Refund Policy Description"></textarea>
