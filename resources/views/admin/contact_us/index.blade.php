...
@section('breadcumb')
    ...
    <li class="breadcrumb-item active"><a href="{{route('admin.contact.index')}}">Contact Us</a></li>
@endsection
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body">
                    <a href="{{route('admin.contact.create')}}" class="pull-right btn btn-xs btn-primary">  <i class="fa fa-plus"></i> Add New
                    </a>
                    <br>
                    <br>
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($contact as $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    <img style="max-height: 50px; max-width: 50px !important;" src="{{asset($item->office_photo)}}">
                                </td>
