...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body">
                    <a href="{{route('admin.blog.create')}}" class="pull-right btn btn-xs btn-primary"> <i
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($blogs as $blog)
                            <tr>
                                ...
                                <td>
                                    @if($blog->image)
                                        <img height="65" width="100" src="{{asset('images/SDIP_blog/'.$blog->image)}}"  alt="{{$blog->title}}">

                                    @else
                                        <img height="65" width="100" src="{{asset('images/noimage.png')}}"  alt="{{$blog->title}}">
